...
description: Use when setting up dtschedule on a new PC or bootstrapping a similar project from scratch — covers repo clone, .env.local setup, Supabase CLI auth, dev server verification, and DB schema init.
---
