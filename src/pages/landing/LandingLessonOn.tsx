  ...
  return (
    <>
      ...
      <div style={{ minHeight: '100vh', background: '#0a0b10', color: '#fff', fontFamily: "-apple-system,BlinkMacSystemFont,'Pretendard','Apple SD Gothic Neo',sans-serif" }}>
        ...
        {/* Nav */}
        <nav style={{ position: 'sticky', top: 0, zIndex: 50, display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 24px', background: 'rgba(10,11,16,0.85)', backdropFilter: 'blur(8px)', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
        ...
        <section style={{ textAlign: 'center', padding: '120px 24px 100px', position: 'relative', overflow: 'hidden' }}>
          <div style={{ position: 'absolute', top: -200, left: '50%', transform: 'translateX(-50%)', width: 900, height: 500, background: 'radial-gradient(circle, rgba(242,96,78,0.18), transparent 70%)', pointerEvents: 'none' }} />
          <div style={{ display: 'inline-block', background: 'rgba(242,96,78,0.13)', color: ACCENT, borderRadius: 20, padding: '4px 14px', fontSize: 12, fontWeight: 700, marginBottom: 24 }}>강사를 위한 회원권 관리</div>
          <h1 style={{ fontSize: 'clamp(32px,6vw,56px)', fontWeight: 800, lineHeight: 1.25, letterSpacing: '-1.2px', margin: '0 auto 24px', maxWidth: 720 }}>
            수업 일정부터 수강권 관리까지.<br /><span style={{ color: ACCENT }}>Lesson On</span> 하나면<br />교육 운영이 더 쉬워집니다.
          </h1>
          <p style={{ fontSize: 17, color: 'rgba(255,255,255,0.5)', maxWidth: 480, margin: '0 auto 40px', lineHeight: 1.7 }}>지금 바로 무료로 시작하세요.</p>
          <button onClick={goStart} style={{ background: ACCENT, color: '#fff', border: 0, borderRadius: 12, padding: '16px 36px', fontSize: 16, fontWeight: 700, cursor: 'pointer', fontFamily: 'inherit', boxShadow: '0 8px 32px rgba(242,96,78,0.35)' }}>무료로 시작하기 →</button>
        </section>
            ...
            <div className="lo-feat-visual" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 20, padding: 28 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                {[
                  ...
                  <div key={r.name} style={{ display: 'grid', gridTemplateColumns: '1fr 1.1fr 0.6fr 0.7fr', alignItems: 'center', background: r.highlight ? 'rgba(242,96,78,0.12)' : 'rgba(255,255,255,0.04)', borderRadius: 12, padding: '12px 16px', fontSize: 13, textAlign: 'center' }}>
        ...
        <section style={{ padding: '80px 24px' }}>
          <div className="lo-feat-grid" style={{ maxWidth: 960, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 32, alignItems: 'center' }}>
            ...
            <div className="lo-feat-text" style={{ order: 1 }}>
        ...
        <section style={{ padding: '80px 24px', background: 'linear-gradient(180deg, transparent, rgba(242,96,78,0.05), transparent)' }}>
          ...
          <div style={{ maxWidth: 760, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 10 }}>
            {[
              ...
              <div key={item.title} style={{ display: 'flex', alignItems: 'center', gap: 14, background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 12, padding: '16px 18px' }}>
        ...
        <section style={{ textAlign: 'center', padding: '80px 24px' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, justifyContent: 'center', maxWidth: 600, margin: '0 auto' }}>
            {['PT·헬스', '요가', '필라테스', '골프 레슨', '무술·격투기', '수영', '발레', '댄스'].map(tag => (
              <span key={tag} style={{ background: 'rgba(255,255,255,0.06)', borderRadius: 20, padding: '6px 14px', fontSize: 13 }}>{tag}</span>
            ))}
          </div>
        </section>
        ...
        <section style={{ padding: '100px 24px' }}>
          <div style={{ maxWidth: 960, margin: '0 auto' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: 16 }}>
              ...
              {/* 5분 셋업 위자드 */}
              <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 14, padding: 18, overflow: 'hidden' }}>
                ...
                <div style={{ fontWeight: 700, marginBottom: 8, paddingLeft: 2 }}>5분 셋업 위자드</div>
                <div style={{ fontSize: 14, color: 'rgba(255,255,255,0.5)', lineHeight: 1.7, paddingLeft: 2 }}>운영 모드·시간 단위·요일 규칙을 7단계 질문으로 안내받아 바로 시작합니다.</div>
              </div>
              ...
              <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 14, padding: 18, overflow: 'hidden' }}>
                ...
                <div style={{ fontWeight: 700, marginBottom: 8, paddingLeft: 2 }}>보기 방식 자유 전환</div>
                <div style={{ fontSize: 14, color: 'rgba(255,255,255,0.5)', lineHeight: 1.7, paddingLeft: 2 }}>월간·주간·일간, 일자별·시간별 보기를 조직과 사용자의 상황에 따라 마음껏 전환할 수 있습니다.</div>
              </div>
              ...
              <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 14, padding: 18, overflow: 'hidden' }}>
                ...
                <div style={{ fontWeight: 700, marginBottom: 8, paddingLeft: 2 }}>실시간 동기화</div>
                <div style={{ fontSize: 14, color: 'rgba(255,255,255,0.5)', lineHeight: 1.7, paddingLeft: 2 }}>강사와 회원이 동시에 캘린더를 봐도 새로고침 없이 즉시 반영되어 중복 예약을 막습니다.</div>
              </div>
              ...
              <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 14, padding: 18, overflow: 'hidden' }}>
                ...
                <div style={{ fontWeight: 700, marginBottom: 8, paddingLeft: 2 }}>반복 등록</div>
                <div style={{ fontSize: 14, color: 'rgba(255,255,255,0.5)', lineHeight: 1.7, paddingLeft: 2 }}>반복 유형·요일·시간대·기간을 지정하면 회원 한 명의 수업을 여러 슬롯에 한 번에 일괄 등록합니다.</div>
              </div>
              ...
              <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 14, padding: 18, overflow: 'hidden' }}>
                ...
                <div style={{ fontWeight: 700, marginBottom: 8, paddingLeft: 2 }}>자동 배정</div>
                <div style={{ fontSize: 14, color: 'rgba(255,255,255,0.5)', lineHeight: 1.7, paddingLeft: 2 }}>역할별로 대표·회원 비율을, 회원별로 가능 요일과 월 최대 횟수를 설정하면 빈 슬롯을 규칙에 맞춰 자동으로 채웁니다.</div>
              </div>
              ...
              <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 14, padding: 18, overflow: 'hidden' }}>
                ...
                <div style={{ fontWeight: 700, marginBottom: 8, paddingLeft: 2 }}>반복 규칙 + 날짜 예외</div>
                <div style={{ fontSize: 14, color: 'rgba(255,255,255,0.5)', lineHeight: 1.7, paddingLeft: 2 }}>"월·수·금 운영" 같은 기본 규칙에 휴관일·특별 운영일을 그날만 따로 지정할 수 있습니다.</div>
              </div>
              ...
              <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 14, padding: 18, overflow: 'hidden' }}>
                ...
                <div style={{ fontWeight: 700, marginBottom: 8, paddingLeft: 2 }}>입력항목 설정</div>
                <div style={{ fontSize: 14, color: 'rgba(255,255,255,0.5)', lineHeight: 1.7, paddingLeft: 2 }}>부상 이력, 보유 레슨권 종류 등 우리 스튜디오만의 항목을 코드 수정 없이 추가합니다.</div>
              </div>
              ...
              <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 14, padding: 18, overflow: 'hidden' }}>
                ...
                <div style={{ fontWeight: 700, marginBottom: 8, paddingLeft: 2 }}>사진 첨부</div>
                <div style={{ fontSize: 14, color: 'rgba(255,255,255,0.5)', lineHeight: 1.7, paddingLeft: 2 }}>회원 자세 교정 사진 등을 배정에 첨부. 브라우저에서 자동 압축돼 용량 걱정이 없습니다.</div>
              </div>
              ...
              <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 14, padding: 18, overflow: 'hidden' }}>
                ...
                <div style={{ fontWeight: 700, marginBottom: 8, paddingLeft: 2 }}>엑셀모드 + 내보내기</div>
                <div style={{ fontSize: 14, color: 'rgba(255,255,255,0.5)', lineHeight: 1.7, paddingLeft: 2 }}>셀을 드래그해 복사·붙여넣기. 한 달 스케줄을 엑셀·CSV·워드·PDF로 내보냅니다.</div>
              </div>
              ...
              <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 14, padding: 18, overflow: 'hidden' }}>
                ...
                <div style={{ fontWeight: 700, marginBottom: 8, paddingLeft: 2 }}>AI 자연어 예약</div>
                <div style={{ fontSize: 14, color: 'rgba(255,255,255,0.5)', lineHeight: 1.7, paddingLeft: 2 }}>"박지은님 화요일 10시 요가 예약"처럼 말하듯 입력하면 자동으로 슬롯에 등록됩니다.</div>
              </div>
        ...
        <section style={{ textAlign: 'center', padding: '60px 24px 100px', borderTop: '1px solid rgba(255,255,255,0.06)' }}>
          ...
          <button onClick={goStart} style={{ background: ACCENT, color: '#fff', border: 0, borderRadius: 12, padding: '16px 36px', fontSize: 16, fontWeight: 700, cursor: 'pointer', fontFamily: 'inherit' }}>지금 무료로 시작하기 →</button>
        </section>
