...
export const WIZARD_STEPS: WizardStepMeta[] = [
  ...
  { n: 6, icon: 'palette',  tone: 'pink',   title: '색상 범례를 추가할까요?', desc: '특별한 날이나 상태를 색상으로 구분할 수 있어요. 건너뛰어도 됩니다.' },
  { n: 7, icon: 'list',     tone: 'green',  title: '추가 정보를 수집할까요?', desc: '배정 등록 시 이름·연락처 외에 더 받을 정보를 설정합니다.' },
]
