...
export const INDUSTRY_CATEGORIES: IndustryTop[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { value: 'rehab',     label: '재활·물리치료' },
      { value: 'mental',    label: '정신건강의학과' },
      { value: 'other',     label: '기타' },
    ],
  },
  {
    ...
    children: [
      ...
      { value: 'music-art', label: '음악·미술 학원' },
      { value: 'language',  label: '어학원' },
      { value: 'coding',    label: '코딩·IT 교육' },
  ...
  },
  {
    ...
    children: [
      ...
      { value: 'golf',      label: '골프' },
      { value: 'dance',     label: '음악·댄스' },
      { value: 'outdoor',   label: '등산·아웃도어' },
  ...
  },
  {
    ...
    children: [
      ...
      { value: 'catering',   label: '케이터링·푸드트럭' },
      { value: 'other',      label: '기타' },
    ],
  },
  {
